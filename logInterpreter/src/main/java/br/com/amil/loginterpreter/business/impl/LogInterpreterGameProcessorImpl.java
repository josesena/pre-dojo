...
/**
 * FIXME Inserir Comentário da Class
 * @author joserenato
 * @version $Id$
 *
 */
public class LogInterpreterGameProcessorImpl extends LogInterpreterGameProcessor {
	...
	/**
	 * Método que adiciona os processos em uma lista e processa de acordo com a implementacao de cada processor
	 * @param line
	 * @param game
	 * @param games
	 * @return
	...
	public String outputGames(List<Game> games) {
		...
		for (Game gameDisplay : games) {
			...
			sb.append(System.getProperty("line.separator"));
			sb.append("Uma sequencia de " +gameDisplay.getPlayerSortedList().get(0).getKillsList().size() + " assassinatos sem morrer");
			sb.append(System.getProperty("line.separator"));
